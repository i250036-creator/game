...
extern int g_switchCounter[MAX_SWITCHES][4]; // Per direction
extern bool g_switchPendingFlip[MAX_SWITCHES];
extern int g_switchSignal[MAX_SWITCHES]; // 0=GREEN, 1=YELLOW, 2=RED
...
extern int g_spawnInterval[MAX_SPAWN_POINTS];
